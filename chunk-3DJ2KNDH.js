import{Ma as P,fa as q,ga as g,ja as A}from"./chunk-7OV45EON.js";import{j as Q,l as E,n as N,s as O}from"./chunk-PH5YPNOT.js";import{Ab as d,Bb as x,Cb as M,Db as w,Ec as B,Kb as l,Lb as D,Mb as F,Pb as f,R as v,Ra as o,Rb as m,S as h,Sb as y,X as T,Xb as j,Yb as S,cb as b,db as C,fa as p,gb as $,hc as z,ib as r,pb as i,sb as k,tb as I,zb as u}from"./chunk-K3BENJQQ.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
